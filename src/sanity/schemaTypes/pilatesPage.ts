  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'image1Video', title: 'Vidéo 1 (mp4, optionnel — remplace l’image 1)', type: 'file', options: { accept: 'video/mp4' } }),
        ...
        defineField({ name: 'image2Video', title: 'Vidéo 2 (mp4, optionnel — remplace l’image 2)', type: 'file', options: { accept: 'video/mp4' } }),
        defineField({ name: 'alt3', title: 'Texte alternatif image 3', type: 'string' }),
        defineField({ name: 'image3', title: 'Image 3 (optionnel)', type: 'image', options: { hotspot: true } }),
        defineField({ name: 'image3Video', title: 'Vidéo 3 (mp4, optionnel — remplace l’image 3)', type: 'file', options: { accept: 'video/mp4' } }),
