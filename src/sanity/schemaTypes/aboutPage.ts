  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'video', title: 'Vidéo portrait (mp4, optionnel — remplace l’image)', type: 'file', options: { accept: 'video/mp4' } }),
      ],
    }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'image5', title: 'Photo 5', type: 'image', options: { hotspot: true } }),
        defineField({ name: 'alt5', title: 'Alt photo 5', type: 'string' }),
        defineField({ name: 'image5Video', title: 'Vidéo 5 (mp4, optionnel — remplace la photo 5)', type: 'file', options: { accept: 'video/mp4' } }),
        defineField({ name: 'image6', title: 'Photo 6', type: 'image', options: { hotspot: true } }),
        defineField({ name: 'alt6', title: 'Alt photo 6', type: 'string' }),
        defineField({ name: 'image6Video', title: 'Vidéo 6 (mp4, optionnel — remplace la photo 6)', type: 'file', options: { accept: 'video/mp4' } }),
      ],
    }),
