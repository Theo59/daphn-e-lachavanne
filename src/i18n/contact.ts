...
const fr = {
  meta: {
    ...
    description:
      'Réservez votre soin ou cours au cabinet de Daphné Lachavanne, 3 rue Valadon, Paris 7e. Drainage Renata França dès 160 €, sur Planity ou par email.',
  },
...
Avant chaque suivi, un court échange permet de comprendre votre demande et d'ajuster la séance à votre moment. Certifiée méthode Renata França depuis 2025, année où Daphné a aussi fondé L'Art de la Circulation. Les retours des personnes reçues sont rassemblés sur Planity, où le cabinet est noté 5,0 / 5.`,
  ...
  faqs: [
    ...
    { q: 'Combien coûte un drainage lymphatique méthode Renata França ?', a: '160 € pour une séance d\'une heure. Le Soin Signature (drainage, breathwork et énergétique, 2h) est à 290 €. Le Soin Signature existe aussi en packs : 3 séances à 850 € (283 € la séance), jusqu’à 259 € la séance pour 10 séances.' },
...
const en = {
  meta: {
    ...
    description:
      'Book your treatment or lesson at Daphné Lachavanne’s studio, 3 rue Valadon, Paris 7th. Renata França drainage, €160, on Planity or by email.',
  },
...
Before every journey, a short conversation helps to understand your needs and tune the session to your moment. Certified in the Renata França method since 2025, the same year Daphné founded L'Art de la Circulation. Feedback from the people she has welcomed is gathered on Planity, where the studio is rated 5.0 / 5.`,
  ...
  faqs: [
    ...
    { q: 'How much does a Renata França lymphatic drainage cost?', a: '€160 for a one-hour session. The Signature Treatment (drainage, breathwork and energy work, 2 hrs) is €290. The Signature Treatment also comes in packs: 3 sessions at €850 (€283 each), down to €259 per session for 10 sessions.' },
