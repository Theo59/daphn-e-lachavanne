...
Certifiée méthode Renata França depuis 2025, Daphné a réuni cette même année son savoir-faire sous un même nom : L’Art de la Circulation. Une approche holistique qui relie le mouvement, le souffle et le travail énergétique, pensée pour libérer les trois corps (physique, mental et émotionnel) sans jamais promettre autre chose qu’un mieux-être.

Quatre pratiques se répondent au cabinet. Les soins, d’abord, avec le drainage lymphatique méthode Renata França (1h, 160 €), le Soin Signature qui mêle drainage, breathwork et énergétique (2h, 290 €), le Miracle Face, drainage du visage et du crâne (40 min, 95 €) et le Combo Détox corps et visage (1h30, 220 €). Des forfaits prolongent le suivi sur la saison. Le breathwork ensuite (cohérence cardiaque à cinq respirations par minute, souffle holotropique, pranayama avancé) en séance individuelle (1h, 90 €) ou en cercle fermé de quatre à six personnes (2h, 60 € par personne). Le yoga enfin, en cours particuliers (vinyasa, hatha, yin), et le Pilates au sol, en privé ou en duo, pour un alignement et un renforcement profonds.
...
Centre bien-être holistique à taille humaine, ce studio de la rive gauche associe soins de drainage et yoga dans un même lieu, pour le corps et l’esprit. Réservation en ligne sur Planity, ou par e-mail à hello@daphnelachavanne.com.`,
  ...
  faqs: [
    ...
    { q: 'Combien coûte un soin ?', a: 'Le drainage lymphatique Renata França est à 160 € (1h), le Soin Signature à 290 € (2h, 260 € 1re séance), le Miracle Face à 90 € (40 min) et le Combo Détox à 220 € (1h30). Le Soin Signature se prend aussi en packs (3 séances à 850 €, soit 283 € la séance, jusqu’à 259 € la séance pour 10 séances).' },
...
Certified in the Renata França method since 2025, that same year Daphné brought her craft together under a single name: L’Art de la Circulation. A holistic approach that links movement, breath and energy work, designed to free the three bodies (physical, mental and emotional) without ever promising anything more than a greater sense of wellbeing.

Four practices answer one another at the studio. Treatments first, with Renata França lymphatic drainage (1 hr, €160), the Signature Treatment blending drainage, breathwork and energy work (2 hrs, €290), the Miracle Face, a drainage of the face and scalp (40 min, €95) and the Detox Combo for body and face (1 hr 30, €220). Packages extend the journey across the season. Then breathwork (cardiac coherence at five breaths per minute, holotropic breathing, advanced pranayama) in a one-to-one session (1 hr, €90) or in a closed circle of four to six people (2 hrs, €60 per person). Lastly yoga, in private lessons (vinyasa, hatha, yin), and mat Pilates, one-to-one or in pairs, for deep alignment and strengthening.
...
A human-scale holistic wellbeing centre, this Left Bank studio brings drainage treatments and yoga together in one place, for body and mind. Book online on Planity, or by email at hello@daphnelachavanne.com.`,
  ...
  faqs: [
    ...
    { q: 'How much does a treatment cost?', a: 'Renata França lymphatic drainage is €160 (1 hr), the Signature Treatment €290 (2 hrs, €260 first session), the Miracle Face €95 (40 min) and the Detox Combo €220 (1 hr 30). The Signature Treatment also comes in packs (3 sessions at €850, i.e. €283 each, down to €259 per session for 10).' },
