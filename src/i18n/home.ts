...
A human-scale holistic wellbeing centre, this Left Bank studio brings drainage treatments and yoga together in one place, for body and mind. Book online on Planity, or by email at hello@daphnelachavanne.com.`,
  ...
  faqs: [
    ...
    { q: 'How much does a treatment cost?', a: 'Renata França lymphatic drainage is €160 (1 hr), the Signature Treatment €290 (2 hrs, €260 first session), the Miracle Face €95 (30 min) and the Detox Combo €220 (1 hr 30). The Signature Treatment also comes in packs (3 sessions at €850, i.e. €283 each, down to €259 per session for 10).' },
